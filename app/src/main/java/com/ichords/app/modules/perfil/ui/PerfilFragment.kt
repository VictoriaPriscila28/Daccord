package com.ichords.app.modules.perfil.ui
...
import com.ichords.app.databinding.FragmentPerfilBinding
import com.ichords.app.modules.perfil.`data`.model.PerfilRowModel
import com.ichords.app.modules.perfil.`data`.viewmodel.PerfilVM
import kotlin.Int
...
class PerfilFragment : BaseFragment<FragmentPerfilBinding>(R.layout.fragment_perfil) {
  ...
  companion object {
    ...
    fun getInstance(bundle: Bundle?): PerfilFragment {
